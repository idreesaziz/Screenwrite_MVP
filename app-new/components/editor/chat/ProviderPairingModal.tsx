...
const PROVIDER_PAIRINGS: ProviderPairing[] = [
  {
    ...
    editEngine: "gemini",
    agent: "gemini",
    label: "Gemini 3 Flash + Gemini 3 Flash",
  ...
  },
  {
    ...
    editEngine: "gemini",
    agent: "gemini-3-low",
    label: "Gemini 3 Flash + Gemini 3 Pro (Low Thinking)",
  ...
  },
  {
    ...
    editEngine: "gemini",
    agent: "gemini-3-high",
    label: "Gemini 3 Flash + Gemini 3 Pro (High Thinking)",
  ...
  },
  {
    ...
    editEngine: "gemini",
    agent: "claude",
    label: "Gemini 3 Flash + Claude Sonnet 4.5",
  ...
  },
  {
    ...
    editEngine: "claude",
    agent: "gemini",
    label: "Claude Sonnet 4.5 + Gemini 3 Flash",
